<?php
define(MySQLprefix, "sc_clean");
$m_Link = mysql_connect("p291927.mysql.ihc.ru", "p291927_nevaa", "gh5dtnbr") or die ("<!-- Ошибка подключения к серверу. -->");
mysql_query("SET NAMES utf8");
mysql_select_db("p291927_nevaa") or die ("<!-- Ошибка соединения с БД. -->");
